...
function createWindow () {
  ...
  mainWindow.openDevTools('/Users/yaobei/Library/Application Support/Google/Chrome/Default/Extensions/hjccockbjjdckanpgpncmegnklpijbho/4.1.4_0')
...
function updateHandle() {
  ...
  autoUpdater.on('update-available', function (info) {
    ...
    if (process.env.NODE_ENV === 'development') {
      BrowserWindow.addDevToolsExtension('/Users/yaobei/Library/Application Support/Google/Chrome/Default/Extensions/hjccockbjjdckanpgpncmegnklpijbho/4.1.4_0')
    }
